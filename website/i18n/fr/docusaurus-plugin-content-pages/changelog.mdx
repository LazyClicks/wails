...
- Restructuration du CLI. Modifié par @leaanthony dans cette [PR](https://github.com/wailsapp/wails/pull/2123)
- Suppression de code injoignable. Modifié par @tmclane dans cette [PR](https://github.com/wailsapp/wails/pull/2182)
